(function() {
    ...
    // After 270s (4m30s) of inactivity, show popup
    var inactivityWarningTime   = 270;
    // Then 30s of warning countdown
    var inactivityCountdownTime = 30;
    // The redirect URL when the 30s countdown ends
    ...
    warningText.textContent = "You have been idle for a while. Please continue with the study or you will be removed from the study!";
